...
public class CustomDropsHandler
{
    ...
    {
        _mConfigFileName = String.format("config/%s/CustomDrops.xml", Const.COLLECTIONID);
    ...
    private void HandleCustomDrops(CustomDrops.CustomDrop tCustomDrop, EntityLivingBase tEntity, EntityPlayer tEP, ArrayList<EntityItem> pDropList)
    {
        try
        {
            ...
            {
                _mPersistedDB = new PersistedDataBase(DimensionManager.getCurrentSaveRootDirectory(), "CustomDrops.dat", Const.COLLECTIONID);
            }
